'use client'
  ...
  export function MeasurementSection() {
    ...
    return (
      <section id="measurement" className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <Card className="lg:col-span-1 border-slate-200 bg-slate-50">
              <CardHeader className="bg-gradient-warm text-slate-900">
              ...
              <CardContent className="p-6">
                <Tabs defaultValue="manual" className="w-full">
                  <TabsList className="grid w-full grid-cols-2 bg-white">
                    <TabsTrigger value="manual" className="data-[state=active]:bg-gradient-warm
  data-[state=active]:text-slate-900">
                      <Ruler className="mr-2 h-4 w-4" />
                      Manual
                    </TabsTrigger>
                    <TabsTrigger value="photo" className="data-[state=active]:bg-gradient-warm
  data-[state=active]:text-slate-900">
